...
import heapq
```
Librería que proporciona una implementación del algoritmo de la cola de prioridad, también conocido como el algoritmo de la cola de montículo (heap queue).
...
import time
```
Librería que proporciona varias funciones para trabajar con el tiempo, incluyendo la posibilidad de pausar la ejecución del programa y recuperar la hora actual.

## Class Board

Contamos con la clase **Board**, la cual cuenta con los siguiente metodos:
